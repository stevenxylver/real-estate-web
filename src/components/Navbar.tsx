        ...
        <header className="w-full bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
                ...
                <nav className="hidden md:flex gap-6 text-sm text-gray-700">
                    ...
                    {latestProperty ? (
                        <Link href={`/properties/${latestProperty.slug}`} className="flex items-center gap-1">
                            {latestProperty.title}
                            <span className="bg-black text-white text-[10px] px-1.5 py-0.5 rounded">New</span>
                        </Link>
                    ) : (
            ...
            {isMenuOpen && (
                <div className="md:hidden border-t">
                    <nav className="flex flex-col px-4 py-4 space-y-4 text-sm text-gray-700">
                        ...
                        {latestProperty ? (
                            <Link href={`/properties/${latestProperty.slug}`} className="flex items-center gap-2">
                                {latestProperty.title}
                                <span className="bg-black text-white text-[10px] px-1.5 py-0.5 rounded">New</span>
                            </Link>
                        ) : (
